...
### Build the Chain
1. Add a main row for the starting owner  
2. Use **Divide** to break into heirs or transfers  
3. Continue building down the chain  
...
- Carl Brass → 111/360  
- Joseph Brass → 85/360 (can be split internally)  
